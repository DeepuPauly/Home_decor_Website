...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        ...
                        <div class="dropdown-menu" aria-labelledby="productsDropdown">
                            ...
                            <a class="dropdown-item" href="admin_add_courier.php">Courier</a>
                            <a class="dropdown-item" href="admin_add_item.php">Products</a>
                            <a class="dropdown-item" href="admin_add_category.php">Category</a>
                            <a class="dropdown-item" href="admin_add_subcategory.php">Sub Category</a>
                             <a class="dropdown-item" href="admin_add_vendor.php">Vendor</a>
 ...
 <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="productsDropdown">
                            <a class="dropdown-item" href="admin_view_staff.php">Staff</a>
                            <a class="dropdown-item" href="admin_view_courier.php">Courier</a>
                             <a class="dropdown-item" href="admin_view_customer.php">Customer</a>
                              <a class="dropdown-item" href="admin_view_customer.php">Customer</a>
                            <a class="dropdown-item" href="admin_view_item.php">Products</a>
                            <a class="dropdown-item" href="admin_view_category.php">Category</a>
                            <a class="dropdown-item" href="admin_view_subcategory.php">Sub Category</a>
                             <a class="dropdown-item" href="admin_view_vendor.php">Vendor</a>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="categoryDropdown">
                            <a class="dropdown-item" href="admin_manage_purchase.php">Purchase Details</a>
