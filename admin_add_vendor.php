...
{
    extract($_POST);
$a="select * from tbl_vendor where Ven_Email='$Username'";
        $b=select($a);
       if (sizeof($b) > 0) {
...
echo$q2="insert into tbl_vendor values(null,'0','$Name','$Username','$City','$District ','$Pin','$Phno','1')";

insert($q2);
  alert('signed up successfully');
  return redirect('admin_add_vendor.php');
}
