...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-lg-between">
      ...
      <h1 class="logo me-auto me-lg-0"><a href="courier_home.php" style="color: #FFC541">ZEIT SPECS</a> <br>
      <span style="color: #FFC541; font-family: Freestyle Script Regular;font-size: 23px ">My subconscious eyes me warily over her tortoiseshell half-moon specs.</span></h1>
