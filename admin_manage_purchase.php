...
if (isset($_POST['crt'])) 
{
    ...
    <section class="home-services py-3" id="services">
        <div class="container py-md-4 py-2">
            <h3 class="title-style text-center mb-lg-5 mb-4">Purchase <span>Details</span></h3>
...
<center>
        ...
        <form method="post">
            <a href="admin_view_purch.php"><input type="button" value="Purchase Report" class="btn btn-dark" style="margin-left: 1165px"></a>
            <!-- <input type="submit" name="crt" value="Purchase Items" class="btn btn-primary" style="margin-left: 15px"> -->
        </form>
        <br>
            ...
            if(sizeof($re)>0){
                ...
                foreach ($re as $row) { ?>
                 ...
                 <tr>
                    ...
                    <td><a href="admin_purchase_item.php?item_id=<?php echo $row['Itm_Id'] ?>" class="btn btn-primary btn-md">Purchase</a></td>
                <?php } ?>
                </tr>
