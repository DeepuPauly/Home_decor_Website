            ...
            <nav class="navbar navbar-expand-lg bg-secondary navbar-dark py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <div class="collapse navbar-collapse justify-content-between px-3" id="navbarCollapse">
                    <div class="navbar-nav ml-auto py-0">
                        <a href="logindex.php" class="nav-item nav-link active">Home</a>
                        <a href="about.php" class="nav-item nav-link">About</a>
                        <a href="customer_view_cart.php" class="nav-item nav-link">My Cart</a>
                        <a href="customer_myorders.php" class="nav-item nav-link">My Orders</a>
                         <a href="my_profile.php" class="nav-item nav-link">My Profile</a>
                        <a href="login1.php" class="nav-item nav-link">Logout</a>
                    </div>
                </div>
            </nav>
        </div>
