            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse " id="navbarScroll">
                  ...
                  <?php  }
                      ?>
                        <li class="nav-item">
                            <a class="nav-link" id="ph" href="staff_view_courier.php">Courier</a>
                        </li> 
                        <li class="nav-item">
                            <a class="nav-link" id="ph" href="staff_view_vendor.php">Vendor</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="ph" href="staff_manage_customer.php">Customer</a>
                        </li>
                        <!-- <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="ph" href="staff_view_item.php">Item</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="ph" href="staff_manage_purchase.php">Purchase</a>
                        </li>
                        <!--  <li class="nav-item">
