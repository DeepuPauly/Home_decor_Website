...
<form method="post">
    ...
    <input type="text" value="" placeholder="Card Number" id="cardno" />
    <input type="text" value="" placeholder="Card Holder Name " id="cardname" />
      <input type="text" value="" placeholder="Bank Name" id="cbname" />
