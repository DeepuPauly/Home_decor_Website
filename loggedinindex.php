...
$q="SELECT * FROM `tbl_item` inner join `tbl_subcat` using(Subcat_Id) inner join `tbl_cat` using(cat_Id) WHERE Status='Active'";
$res=select($q);

if(isset($_GET['brand'])){
    extract($_GET);
    $q="SELECT * FROM `tbl_item` inner join `tbl_brand` using(brand_id) inner join `tbl_variant` using(variant_id) WHERE `brand_name`='$brand'";
    $res=select($q);
}
if(isset($_GET['view_more'])){
    extract($_GET);
    $q="SELECT * FROM `tbl_item` inner join `tbl_subcat` using(Subcat_Id) inner join `tbl_variant` using(variant_id)";
    $res=select($q);
}
 ...
 ?>
                ...
                <div class="container">
                    <div class="hero-content">
                        ...
                        <h1 data-animation="flipInX" data-delay="0.8s" data-color="#fff">
                            Latest<span> Phones </span>Available<span>.</span></h1>
    ...
    <div class="w3l-servicesblock2 py-5" id="services">
        <div class="container py-lg-5 py-md-4 py-2">
            <h3 class="title-style text-center mb-lg-5 mb-4">What we <span>Offer</span></h3>
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="grids5-info">
                        <a href="?brand=Apple#ss" class="blog-image d-block zoom"><img src="assets/images/apple.png" alt=""
                ...
                <div class="col-lg-3 col-sm-6 mt-sm-0 mt-4">
                    <div class="grids5-info">
                        <a href="?brand=Samsung#ss" class="blog-image d-block zoom"><img src="assets/images/samsung.png" alt=""
                                class="img-fluid radius-image" />
                            <div class="image-overlay">
                                <h4>Samsung</h4>
                                <p>Designed For.</p>
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="grids5-info">
                        <a href="?brand=Oneplus#ss" class="blog-image d-block zoom"><img src="assets/images/oneplus.png" alt="" class="img-fluid radius-image" />
                            <div class="image-overlay">
                                <h4>OnePlus</h4>
                                <p>Never Settle.</p>
                            </div>
                ...
                <div class="col-lg-3 col-sm-6 mt-lg-0 mt-4">
                    <div class="grids5-info">
                        <a href="?brand=Xiaomi#ss" class="blog-image d-block zoom"><img src="assets/images/xiaomi.png" alt=""
                                class="img-fluid radius-image" />
                            <div class="image-overlay">
                                <h4>Xiaomi</h4>
                                <p>Power Has a New Look.</p>
                            </div>
                            <div class="iconic-plus">
                                <i class="fas fa-plus"></i>
                            </div>
            ...
            <div class="text-center mt-md-5 mt-5 pt-lg-4">
                <a href="?view_more#ss" class="btn btn-style">View All</a>
            </div>
        </div>
    </div>
    <!-- //home services block -->
    ...
    <section class="home-services py-5" id="services">
        <div class="container py-lg-5 py-md-4 py-2">
            <h3 class="title-style text-center mb-lg-5 mb-4">How<span> we are the </span>Best.</h3>
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="box-wrap">
                        ...
                        <h4><a href="#url">High Quality</a></h4>
                        <p>Aims to offer variety of the latest mobiles phones released worldwide and always provided high quality yet budget-friendly products online.</p>
                ...
                <div class="col-lg-4 col-md-6 mt-lg-4 mt-4">
                    <div class="grids5-info">
                                ...
                                <?php
                                    ...
                                    if($row['stock']=='0')
                                    {  ?><a href="" class="blog-image d-block zoom" style="height:370px"><img src="<?php echo $row['img1']?>">
                                        <div class="image-overlay">
                                       <span>Out of Stock</span>
                                  <?php  }
                                    elseif ($row['stock']<'4')
                                    {  ?>
                                        <a href="add_qty_cart.php?id=<?php echo $row['item_id']?>&img=<?php echo $row['img1'] ?>&stock=<?php echo $row['stock'] ?>" class="blog-image d-block zoom" style="height:370px"><img src="<?php echo $row['img1']?>">
                                            <div class="image-overlay">
...
<center>
                            <h4><?php echo $row['brand_name']?> <?php echo $row['item_name']?></h4>
                        <p>Ram: <?php echo $row['ram']?>GB , Storage: <?php echo $row['storage']?>GB</p>
                        <p>Display: <?php echo $row['display']?></p>
                        <p>Processor: <?php echo $row['processor']?></p>
                        <!-- <p>Camera</p> --> 
                        <p>Front Camera: <?php echo $row['frontcamera']?></p>
                        <p>Back Camera: <?php echo $row['backcamera']?></p>
                        ...
                        <?php
                                  ...
                                  <?php  }
                                    ...
                                    {  ?>
                                       <a href="add_qty_cart.php?id=<?php echo $row['item_id']?>&img=<?php echo $row['img1'] ?>&stock=<?php echo $row['stock'] ?>" class="btn btn-style" >View More</a>
                                   <?php }
