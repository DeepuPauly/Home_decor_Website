  ...
  else
{
  ...
  if (sizeof($qr)>0) {
      ...
      $qq="SELECT * from tbl_childcart where Itm_Id='$id' and mastcart_id='$cmmid'";
      $qqs=select($qq);
...
<?php 
    $q="SELECT * FROM `tbl_item` inner join `tbl_subcat` using(Subcat_Id) inner join `tbl_purchild` using(Itm_Id) where Itm_Id='$id'";
    $res=select($q);
    $r="SELECT * FROM `tbl_item` inner join `tbl_purchild` using(Itm_Id) where Itm_Id ='$id'";
    $req=select($r);
 ?>
  
                <!-- <div class="col-lg-4 col-md-6 mt-lg-4 mt-4"> -->
                    <div class="grids5-info" >
                        <a href="#blog" class="blog-image d-block zoom" style="height:370px"><img src="<?php echo $res[0]['Image']?>">
        ...
        <div class="col-md-6 col-lg-8">
                      ...
                      <form method="post" >
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="item" placeholder="Item" class="form-control" readonly style="opacity: .7;" value="<?php echo $res[0]['Itm_name']?>">
                          </div><br><br>
                          <div class="form-group col-md-6">
                            <h5>Price</h5>
                            <br>
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" name="t_amount" readonly="" placeholder="Total Amount" class="form-control" required style="opacity: .7;" id="t_amount">
                          </div><br>
