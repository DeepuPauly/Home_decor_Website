...
// $q2="insert into tbl_vendor values(null,'$Username','$Firstname','$Lastname','$Address','$Phonenumber','$Gender','$Dob','1')";
...
li a:hover {
  background-color: black;
    ...
    <body style="background: url('pot.jpg');">
    <ul>
...
<form method="post">
 ...
 <!--      <input type="password"value=""name="Password" placeholder="Password" id="Password" required=""/> -->
    ...
    <input type="text"value="" name="Lastname"placeholder="City" id="Lastname" required="" />
    <input type="text"value="" name="Address"placeholder="District" id="Address" required="" />
    <input type="number"value=""name="Phonenumber"placeholder="Pin" id="Phonenumber"required=""  />
       <input type="number"value=""name="Phonenumber"placeholder="Phone" id="Phonenumber"required=""  />
